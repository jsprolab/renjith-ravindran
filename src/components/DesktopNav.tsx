...
export const DesktopNav = () => {
    ...
    return (
        <header className="lg:w-auto h-[144px] hidden lg:block p-[20px] ml-auto mb-10 rounded-[16px] bg-white dark:bg-[#212020]" data-aos="fade-left">
            <nav className={`block mx-auto`}>
                ...
                {menuItems.map((item) => (
                    ...
                    className={`w-[90px] h-20 rounded-[10px] cursor-pointer transition-all duration-300 ease-in-out font-poppins bg-[#F3F6F6] font-medium mx-1.5 text-xtiny justify-center flex flex-col items-center ${
